...
bool multi_mode_control_msgs__msg__controller__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("multi_mode_control_msgs.msg._controller.Controller", full_classname_dest, 50) == 0);
  }
  multi_mode_control_msgs__msg__Controller * ros_message = _ros_message;
  {  // name
  ...
  {  // resources
    ...
    }
    {
      ...
      rosidl_runtime_c__String * dest = ros_message->resources.data;
...
PyObject * multi_mode_control_msgs__msg__controller__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("multi_mode_control_msgs.msg._controller");
  ...
  {  // resources
    ...
    rosidl_runtime_c__String * src = ros_message->resources.data;
